...
public class SvModificar extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(SvModificar.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    public void mostrarFormulario(PrintWriter out) throws SQLException {
        ...
        out.println("<html>"
                ...
                + "<h1><font color=sienna face='Arial'>MODIFICAR CITA</font></h1>");
        if (cdr.isBeforeFirst() == false) {
            out.println("<br>TODAS LAS TUTORÍAS ESTÁN CONCERTADAS "
                    + "<br></center></body></html>");
            return;
        }
        out.println("<form action='SvModificar'"
                + "method=post>"
        ...
        out.println("</select><br><br><font face='Arial'>Alumno:"
                + "</font>&nbsp;&nbsp;&nbsp;&nbsp;"
                + "<input type='text' name='alumno' size='60'>"
                + "<br><font face='Arial'>Asunto:</font>"
